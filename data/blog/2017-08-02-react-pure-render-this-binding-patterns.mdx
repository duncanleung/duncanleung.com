...
```js {3,11}// Not recommended, omitting props.
constructor() {
  super();
...
```js {17}class Form extends React.Component {
  constructor(props) {
    super(props);
...
```js {10,15}class Form extends React.Component {
  constructor(props) {
    super(props);
...
```js {13}class Form extends React.Component {
  constructor(props) {
    super(props);
...
```js {10}var Form = React.createClass({
  getInitialState() {
    return {
      name: "Joe"
    };
...
```js {9,20,22}class Form extends React.Component {
  constructor(props) {
    super(props);
