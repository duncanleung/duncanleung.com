...
date: '2017-08-14'
tags: ['react', 'javascript', 'debugging', 'events', 'state-management']
summary: 'A detailed guide to understanding and resolving React synthetic event warnings in setState, including best practices for event handling and state updates.'
...
It turns out [React has it's own event system](https://facebook.github.io/react/docs/events.html) for event handling, using `SyntheticEvent`.
