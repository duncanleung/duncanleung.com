...
summary: 'A guide to configure Emotion CSS prop with JSX Pragma in Storybook, including setup, troubleshooting, and best practices.'
...
```ts {8,20}const path = require("path");
