...
date: '2020-01-10'
tags: ['storybook', 'emotion']
summary: 'A guide to implementing Emotion Theme Provider decorators in Storybook, including troubleshooting common issues and best practices for theme management.'
...
```js {13,15}import React, { ReactNode } from "react";
import { ThemeProvider } from "emotion-theming";
...
```js {5-7}import React from "react";
import { ThemeProvider } from "emotion-theming";
import theme from "~/theme";
