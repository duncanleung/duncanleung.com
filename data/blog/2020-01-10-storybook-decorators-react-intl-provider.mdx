...
date: '2020-01-10'
tags: ['storybook', 'i18n']
summary: 'A guide to configure React-Intl Provider decorators in Storybook for internationalization testing, including setup and best practices.'
...
```js {32,33,36}// !! This does not work
...
```js {15-17}import React from "react";
...
```js {34}import { setIntlConfig, withIntl } from "storybook-addon-intl";
