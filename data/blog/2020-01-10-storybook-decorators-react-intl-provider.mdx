---
title: 'Setting Up React-Intl Provider Decorators in Storybook'
date: '2020-01-10'
tags: ['react', 'storybook', 'i18n', 'react-intl', 'testing']
summary: 'A comprehensive guide to configuring React-Intl Provider decorators in Storybook for internationalization testing, including setup and best practices.'
