---
title: 'Using AWS Amplify aws-exports.js with TypeScript'
date: '2020-01-13'
tags: ['aws', 'amplify', 'typescript', 'configuration']
summary: 'A guide to properly typing and integrating AWS Amplify configuration files in TypeScript projects, with focus on aws-exports.js setup.'
