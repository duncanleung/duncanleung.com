---
title: 'Profiling and Optimizing ESLint Rules Performance'
date: '2020-01-16'
tags: ['eslint', 'javascript', 'performance', 'tooling', 'optimization']
summary: 'A detailed guide to profiling, measuring, and optimizing slow ESLint rules, with practical techniques for improving linting performance.'
