...
date: '2020-01-28'
tags: ['eslint', 'javascript', 'tooling', 'configuration', 'linting']
summary: 'A comprehensive guide to setting up ESLint, explaining the differences between ESLint config files and plugins, with detailed configuration examples and best practices.'
