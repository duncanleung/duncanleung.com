...
[Conditional Types](https://www.typescriptlang.org/docs/handbook/advanced-types.html#conditional-types) allow you to select one of two possible types based on a type-relationship condition.
...
- Is `A` a possibly-more-specific version of `B`
