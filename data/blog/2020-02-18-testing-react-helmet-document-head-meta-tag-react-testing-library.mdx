...
```tsx {7-17,26-30,37}import React from "react";
...
```tsx {21}import React, { useEffect } from "react";
...
/**
 * An SEO component that handles all elements in the head that can accept
 */
