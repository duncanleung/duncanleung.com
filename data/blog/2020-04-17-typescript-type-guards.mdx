...
date: '2020-04-17'
tags: ['typescript']
summary: 'A guide to use TypeScript type guards for runtime type checking and type narrowing in your TypeScript applications.'
 ...
 */
export const isS3Document = (document: Document): document is S3Document => 'url' in document
```

You could use the **type-guard** as such:

```typescript {2}const onlyS3Files = (files: Document[]): S3Document[] =>
