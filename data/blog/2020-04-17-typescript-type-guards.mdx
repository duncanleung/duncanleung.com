...
date: '2020-04-17'
tags: ['typescript']
summary: 'A guide to using TypeScript type guards for runtime type checking and type narrowing in your TypeScript applications.'
...
```typescript
/**
 * Type-Guard: Asserts that the document is an S3 file
 */
