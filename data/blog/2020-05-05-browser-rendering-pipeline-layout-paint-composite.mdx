...
- [HTTP Cache-Control: ETag, Revalidation, and the Two Caching Strategies](/blog/http-cache-control-etag-revalidation-strategies) - the pipeline can only run on bytes it has; caching determines whether those bytes have to be fetched at all
