---
title: 'Managing Multiple AWS Profiles with CLI and Serverless'
date: '2020-05-05'
tags: ['aws', 'cli', 'serverless', 'devops', 'configuration']
summary: 'A comprehensive guide to setting up and switching between multiple AWS profiles when working with AWS CLI and Serverless Framework projects.'
