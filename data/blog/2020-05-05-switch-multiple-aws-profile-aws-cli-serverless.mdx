...
date: '2020-05-05'
tags: ['aws', 'serverless']
summary: 'A guide to set up and switch between multiple AWS profiles when working with AWS CLI and Serverless Framework projects.'
