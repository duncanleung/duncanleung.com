---
title: 'Securing AWS API Gateway Endpoints: Cognito, IAM, and API Keys'
date: '2020-05-30'
tags: ['aws', 'serverless', 'security', 'api-gateway', 'authentication']
summary: 'A comprehensive guide to implementing authentication and authorization in AWS API Gateway, covering Cognito User Pools, IAM roles, and API keys with practical examples.'
...
<img
  className="avatar"
  src="../../content/images/post-images/2020-05-29-lambda-get-api.png"
  alt=""
/>
...
<img
  className="avatar"
  src="../../content/images/post-images/2020-05-29-lambda-post-api.png"
  alt=""
/>
...
<img
  className="avatar"
  src="../../content/images/post-images/2020-05-29-lambda-fanout-api.png"
  alt=""
/>
