...
```yaml {12-14,18-52,54-62,64-72,74-83}
provider:
  name: aws
  runtime: nodejs12.x
...
After you redeploy the stack, the API key names and values will be returned in the Serverless CLI output:
