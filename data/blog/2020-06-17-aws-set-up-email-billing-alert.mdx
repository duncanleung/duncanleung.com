---
title: 'Configuring AWS Email Billing Alerts with CloudWatch'
date: '2020-06-17'
tags: ['aws', 'cloudwatch', 'monitoring']
summary: 'A detailed guide to setting up automated email billing alerts in AWS using CloudWatch metrics and SNS notifications for cost monitoring.'
images: ['/static/thumbnails/aws.png']
draft: false
---

It's a good practice to set up billing alerts when you're first getting started with AWS to avoid unexpected charges that can be caused by forgetting to clean up and remove unused services.
...
4. Enable **"Receive Billing Alerts"** to send billing alerts via email when your charges reach a specified threshold.

<img
  className="avatar"
  src="/static/images/post-images/2020-06-17-billing-preferences.png"
  alt=""
/>
...
<img
  className="avatar"
  src="/static/images/post-images/2020-06-17-cloudwatch-billing-alarms-dashboard.png"
  alt=""
/>
...
<img
  className="avatar"
  src="/static/images/post-images/2020-06-17-billing-alarm-threshold.png"
  alt=""
/>
...
<img
  className="avatar"
  src="/static/images/post-images/2020-06-17-billing-alarm-sns-topic.png"
  alt=""
/>
...
<img
  className="avatar"
  src="/static/images/post-images/2020-06-17-billing-alarm-set-name.png"
  alt=""
/>
...
<img
  className="avatar"
  src="/static/images/post-images/2020-06-17-billing-alarm-preview-create.png"
  alt=""
/>
...
<img
  className="avatar"
  src="/static/images/post-images/2020-06-17-cloudwatch-pending.png"
  alt=""
/>
...
<img
  className="avatar"
  src="/static/images/post-images/2020-06-17-sns-pending-confirmation.png"
  alt=""
/>
...
<img className="avatar" src="/static/images/post-images/2020-06-17-sns-email.png" alt="" />
...
<img
  className="avatar"
  src="/static/images/post-images/2020-06-17-sns-email-confirmed.png"
  alt=""
/>
...
<img
  className="avatar"
  src="/static/images/post-images/2020-06-17-sns-confirmed.png"
  alt=""
/>
