...
date: '2021-06-16'
tags: ['backend', 'go']
summary: 'Understanding the difference between indexing strings as bytes versus runes in Go, and when to use each approach for proper Unicode handling.'
images: ['/static/thumbnails/go.png']
draft: false
---

I've been using <a href='https://exercism.io/tracks/go' target='_blank'>exercism's Go track</a> to help me learn Go. It's been an amazing experience so far. Exercism is a mentor-based exercise platform that allows students to request feedback from mentors.
...
If we wish to increment the index by character, we must either cast the slice to a string or rune.
