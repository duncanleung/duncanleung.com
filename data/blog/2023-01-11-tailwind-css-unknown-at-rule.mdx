...
date: '2023-01-11'
tags: ['tailwind', 'css']
summary: 'Fixing VSCode warnings for Tailwind CSS directives by creating custom CSS data configuration files for proper syntax recognition.'
images: ['/static/thumbnails/tailwind.png']
draft: false
---
