...
In addition to allowing modifying the original value in a calling function, passing a pointer is also used to indicate that a function parameter is optional.
