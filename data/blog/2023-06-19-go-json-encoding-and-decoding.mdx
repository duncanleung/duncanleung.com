...
date: '2023-06-19'
tags: ['backend', 'go']
summary: 'A comprehensive guide to JSON serialization and deserialization in Go, covering type mappings, HTTP responses, and practical examples with the net/http package.'
