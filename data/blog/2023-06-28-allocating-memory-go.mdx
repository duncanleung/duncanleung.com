...
date: '2023-06-28'
tags: ['backend', 'go']
summary: 'Understanding memory allocation in Go, including stack vs heap allocation, escape analysis, and how Go handles pointer returns from functions.'
images: ['/static/thumbnails/go.png']
draft: false
---

It can be helpful to understand how memory is allocated when working in Go, as it will provide some insight into how the Go runtime and garbage collector decides when to deallocate memory.
