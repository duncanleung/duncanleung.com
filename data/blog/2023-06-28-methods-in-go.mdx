...
date: '2023-06-28'
tags: ['backend', 'go']
summary: 'Understanding Go methods, the difference between value and pointer receivers, embedding for composition, and how interfaces work with methods.'
...
Embedding also allows a struct to "borrow" fields and methods of another struct via composition. This means modifying or extending behavior can be done without modifying the original struct.
