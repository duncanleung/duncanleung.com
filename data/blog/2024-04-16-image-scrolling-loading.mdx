...
I encountered a frustrating scrollling user experience in our chat platform that was occurring due to a race condition of images loading within the chat, and a scroll-to-bottom function.
