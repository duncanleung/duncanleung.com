...
date: '2024-07-18'
tags: ['eslint', 'typescript', 'javascript', 'tooling', 'development']
summary: 'A comprehensive guide to the upcoming changes in ESLint v9 regarding TypeScript integration, including migration strategies and best practices.'
...
When I included the the `typescript-eslint` configuration to lint with type information:
...
This type information is only available when ESLint procceses TypeScript files with the TypeScript parser with the `parserOptions.project` configuration.
