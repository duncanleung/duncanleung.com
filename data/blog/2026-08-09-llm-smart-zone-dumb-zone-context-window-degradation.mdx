...
- **In DUMB zone**: How urgently you compact depends on depth. At `DUMB +0` to `+100K`, you've just crossed the threshold, so finish your task, then compact. At `DUMB +500K`+, most of your early context is effectively invisible and a summary is strictly better than what the degraded attention mechanism is retaining.
